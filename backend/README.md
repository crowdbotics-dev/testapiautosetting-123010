...
## Project Structure
    ...
    ├── testapiautosetting_123010  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123010`
...
2. Clone this repo and `cd testapiautosetting_123010`
